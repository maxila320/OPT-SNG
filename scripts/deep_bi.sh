...
RESULT_LOG="r_tuning_results.csv"
DEBUG_LOG="diskann_debug.log"
...
test_r_value() {
    ...
    INDEX_PATH_PREFIX="data/deep1M/disk_index_deep1M_learn_R${R}_L${L_BUILD}_A${A_BUILD}"
    ...
    CURRENT_SCORE=$(echo "scale=4; $RECALL/9 - $LATENCY/10 " | bc)
