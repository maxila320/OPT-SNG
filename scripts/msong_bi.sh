...
DATATYPE="float"
A_BUILD=2.00
QUERY_FILE="data/msong/msong_query.fbin"
GT_FILE="data/msong/msong_query_base_gt100"
DATA_PATH="data/msong/msong_base.fbin"
B_BUILD=0.025
M_BUILD=40.0
K_SEARCH=10
RESULT_PATH="data/msong/res"
L_BUILD=90
L_SEARCH=3000
...
RESULT_LOG="r_tuning_results_msong.csv"
DEBUG_LOG="diskann_debug_msong.log"
...
test_r_value() {
    ...
    INDEX_PATH_PREFIX="data/msong/msong_index_msong_base_R${R}_L${L_BUILD}_A${A_BUILD}"
    ...
    CURRENT_SCORE=$(echo "scale=4; $RECALL/9 - $LATENCY/300 " | bc)
    # 一般latency更大，
